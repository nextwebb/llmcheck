...
<main><div class="eyebrow">Capture · Review · Replay</div><h1>A passing check deserves an explanation.</h1><p>Turn a bad LLM response into a reviewed regression case. Inspect the answer, the judge's evidence, and the rule that produced the verdict.</p><div class="links"><a href="#explorer">Explore 12 cases ↓</a><a href="https://github.com/nextwebb/llmcheck/tree/main/examples/refund-policy">Run the refund-policy example</a><a href="https://github.com/nextwebb/llmcheck/tree/main#install">Run locally</a></div>
